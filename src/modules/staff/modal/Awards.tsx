...
export const AwardsModal =(props:any)=> {
...
<div className="">
<label htmlFor="" className="form-title text-sm leading-1 text-color-gray-2 "> Year</label>
