...
const Experience = () => {
 ...
 <h5 className='text-base font-semibold leading-4'>Work Experience</h5>
    ...
    <table className="custom-table  w-max  rounded-md  ">
      <thead>
        <tr>
          ...
          <th>Organization</th>
          <th>Job Title</th>
          <th><div className="flex items-center gap-1"> <FaLink data-tooltip-id="table" data-tooltip-content="Present the exam key larger"/> Start Date</div></th>
    
          <th><div className="flex items-center gap-1"> <FaLink data-tooltip-id="table" data-tooltip-content="Present the exam key larger"/>End Date</div></th>
