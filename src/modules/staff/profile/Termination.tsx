...
const Termination = () => {
  ...
  <h5 className='text-base font-semibold leading-4'>Terminate Account</h5>
...
<div className="col-span-3">
  <label htmlFor="" className="form-title text-sm leading-1 text-color-gray-2 "> Termination Note</label>
