...
<input type="text" className="form-group text-xs" placeholder="Search " />
 ...
 <ul className="sidebar  h-full overflow-scroll   pb-24 ">
        ...
        <li> <Link to='/result/grading'><FaUserFriends/> Grading System</Link></li>

        <li> <Link to='/result/comments'><FaUserFriends/> Comment Bank</Link></li>


  <li> <Link to='/result/template'><FaUserFriends/> Result Template</Link></li>

   <li> <Link to='/result/template'><FaUserFriends/> Score Entries</Link></li>

<li> <Link to='/result/template'><FaUserFriends/> Import Scores From File</Link></li>
